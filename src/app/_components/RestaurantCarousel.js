...
const RestaurantCarousel = ({
    ...
    console.log("type", type, foodList, restaurants)
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="flex items-center justify-between mb-6 px-4">
                ...
                {(restaurants?.length > 0 || foodList?.length > 0) && (
                    <div className="flex items-center gap-2">
                        <button
                            className={`h-8 w-8 bg-white shadow rounded-full flex items-center justify-center transition-all duration-200 ${showLeftArrow
                        ...
                        <button
                            className={`h-8 w-8 bg-white shadow rounded-full flex items-center justify-center transition-all duration-200 ${showRightArrow
                                ? "opacity-100 cursor-pointer hover:bg-gray-50"
                                : "opacity-40 cursor-not-allowed"
                                }`}
            ...
            <div
                ref={currentRef}
                className={`overflow-x-auto scroll-smooth no-scrollbar flex gap-4 px-4 pb-4 ${foodList?.length === 0 && "justify-center"}`}
                style={{
